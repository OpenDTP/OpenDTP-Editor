...
function HeaderViewport(i,e){this.base=AbstractViewport,this.base(i,e),this.load=function(i){this.editor=i,this.node=$('<div class="header"><div class="title">PACO Editor v0.1</div><div class="version-wrapper"><div class="version">'+this.editor.map.name+"</div></div></div>"),this.editor.node.append(this.node)}}HeaderViewport.prototype=new AbstractViewport;
