...
function Editor(e,i,t){this.node=null,this.map=null,this.renderer=null,this.viewports={header:new HeaderViewport,toolbar:new ToolbarViewport,map:new MapViewport,preview:new PreviewViewport,footer:new FooterViewport,popup:new PopupViewport};this.properties={current_spread:0},this.menu_items={File:{},Edit:{},View:{"Show / Hide right pannel":function(e){e.right_pannel.toggle(),e.right_pannel.is(":visible")?e.map_viewport.addClass("right-space"):e.map_viewport.removeClass("right-space")},"Show / Hide left pannel":function(e){e.left_pannel.toggle(),e.left_pannel.is(":visible")?e.map_viewport.addClass("left-space"):e.map_viewport.removeClass("left-space")}},Help:{About:function(){alert("the fucking awesome editor\nPACO Editor v0.1")}}};this.load=function(e,i){this.node=$(e),this.map=i,this.node.addClass("mapeditor");for(var t in this.viewports)!0===this.viewports[t].active&&(this.viewports[t].load(this),!1===this.viewports[t].displayed&&this.viewports[t].hide());this.mapResize(),$(window).resize(this,this.mapResize)},this.mapResize=function(e){var i=void 0===e?this:e.data,t=i.viewports,o=t.map.node.find(".map-wrapper"),r=(t.map.node.outerWidth(!0)-t.map.node.width(),t.map.node.outerHeight(!0)-t.map.node.height());t.map.node.css("height",i.node.height()-t.header.node.outerHeight(!0)-t.footer.node.outerHeight(!0)-r),t.toolbar.node.css("height",i.node.height()-t.header.node.outerHeight(!0)-t.footer.node.outerHeight(!0)),t.preview.node.css("height",i.node.height()-t.header.node.outerHeight(!0)-t.footer.node.outerHeight(!0)),$(o).css("line-height",t.map.node.height()+"px"),i.renderer.resizeMap(),i.node.trigger("change")},this.loadPlugins=function(e){for(var i,t=e.length-1;t>=0;t--)i=new e[t],i.load(this),this.plugins.push(i)},void 0!==e&&void 0!==i&&this.load(e,i,t)}
