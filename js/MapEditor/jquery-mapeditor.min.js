...
function HeaderViewport(e,t){this.base=AbstractViewport,this.base(e,t),this.menu_node=$('<div class="menu"></div>'),this.load=function(e){this.editor=e,this.node=$('<div class="header"><div class="title">PACO Editor v0.1</div><div class="version-wrapper"><div class="version">'+this.editor.map.name+"</div></div></div>"),this.menu(),this.node.append(this.menu_node),this.editor.node.append(this.node)},this.menu=function(e){var t,n,i;!0===e&&this.menu_node.html(""),t=function(e){e.data.hideMenu(),$(e.target).hasClass("selected")||e.data.showMenu(e.target)};for(var s in this.editor.menu_items)n=$('<div class="menu-item">'+s+"</div>"),i=$("<ul></ul>"),this.menuRecurse(i,this.editor.menu_items[s]),n.click(this,function(e){e.data.showMenu(e.target),e.data.menu_node.find(".menu-item").mouseenter(e.data,t)}),n.append(i),this.menu_node.append(n);this.node.mouseleave(this,function(e){$(e.target).hasClass("selected")||e.data.hideMenu(),e.data.menu_node.find(".menu-item").unbind("mouseenter",t)})},this.menuRecurse=function(e,t){var n=$("<ul></ul>");for(var i in t)submenu_element=$("<li>"+i+"</li>"),e.append(submenu_element),"function"==typeof t[i]?submenu_element.click({editor:this.editor,element:t[i]},function(e){e.data.element(e.data.editor)}):"object"==typeof t[i]&&(n=$("<ul></ul>"),submenu_element.append(n),submenu_element.mouseover({viewport:this,menu:e},function(e){console.log(e.target),e.data.viewport.showMenu(e.target)}),this.menuRecurse(n,t[i]))},this.showMenu=function(e){$(e).addClass("selected"),$(e).children("ul").show()},this.hideMenu=function(e){void 0===e&&(e=this.menu_node),e.find("ul").hide(),e.find(".menu-item").removeClass("selected")}}HeaderViewport.prototype=new AbstractViewport;
