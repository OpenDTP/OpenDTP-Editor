...
function Editor(e,i,o){this.node=null,this.map=null,this.renderer=null,this.viewports={header:new HeaderViewport,toolbar:new ToolbarViewport,map:new MapViewport,preview:new PreviewViewport,footer:new FooterViewport,popup:new PopupViewport},this.properties={current_spread:0},this.menu_items={File:{},Edit:{test:{plop:"",plop2:""},test2:{plop:"",plop2:""}},View:{"Show / Hide right pannel":function(e){e.viewports.preview.node.toggle(),e.viewports.preview.node.is(":visible")?e.viewports.map.node.addClass("right-space"):e.viewports.map.node.removeClass("right-space")},"Show / Hide left pannel":function(e){e.viewports.toolbar.node.toggle(),e.viewports.toolbar.node.is(":visible")?e.viewports.map.node.addClass("left-space"):e.viewports.map.node.removeClass("left-space")}},Help:{About:function(){alert("the fucking awesome editor\nPACO Editor v0.1")}}},this.plugins=[],this.load=function(e,i,o){this.node=$(e),this.map=i,this.node.addClass("mapeditor");for(var t in this.viewports)!0===this.viewports[t].active&&(this.viewports[t].load(this),!1===this.viewports[t].displayed&&this.viewports[t].hide());this.mapResize(),void 0!==o&&o.length>0&&this.loadPlugins(o),$(window).resize(this,this.mapResize)},this.mapResize=function(e){var i=void 0===e?this:e.data,o=i.viewports,t=o.map.node.find(".map-wrapper"),s=(o.map.node.outerWidth(!0)-o.map.node.width(),o.map.node.outerHeight(!0)-o.map.node.height());o.map.node.css("height",i.node.height()-o.header.node.outerHeight(!0)-o.footer.node.outerHeight(!0)-s),o.toolbar.node.css("height",i.node.height()-o.header.node.outerHeight(!0)-o.footer.node.outerHeight(!0)),o.preview.node.css("height",i.node.height()-o.header.node.outerHeight(!0)-o.footer.node.outerHeight(!0)),$(t).css("line-height",o.map.node.height()+"px"),i.renderer.resizeMap(),i.node.trigger("change")},this.loadPlugins=function(e){for(var i,o=e.length-1;o>=0;o--)i=new e[o],i.load(this),this.plugins.push(i)},void 0!==e&&void 0!==i&&this.load(e,i,o)}
...
function HeaderViewport(e,t){this.base=AbstractViewport,this.base(e,t),this.menu_node=$('<div class="menu"></div>'),this.load=function(e){this.editor=e,this.node=$('<div class="header"><div class="title">PACO Editor v0.1</div><div class="version-wrapper"><div class="version">'+this.editor.map.name+"</div></div></div>"),this.menu(),this.node.append(this.menu_node),this.editor.node.append(this.node)},this.menu=function(e){var t,i;!0===e&&this.menu_node.html("");for(var n in this.editor.menu_items)t=$('<div class="menu-item">'+n+"</div>"),i=$("<ul></ul>"),this.menuRecurse(i,this.editor.menu_items[n]),t.click(this,function(e){e.data.toggleMenu(e.target)}),t.mouseenter(this,function(e){0!==e.data.menu_node.find(".selected").length&&"div"===e.target.localName&&e.data.toggleMenu(e.target)}),t.append(i),this.menu_node.append(t);this.menu_node.mouseleave(this,function(e){e.data.hideMenu()})},this.menuRecurse=function(e,t){var i=$("<ul></ul>");for(var n in t)submenu_element=$("<li>"+n+"</li>"),e.append(submenu_element),"function"==typeof t[n]?submenu_element.click({editor:this.editor,element:t[n]},function(e){e.data.element(e.data.editor)}):"object"==typeof t[n]&&(i=$("<ul></ul>"),submenu_element.append(i),submenu_element.mouseover({viewport:this,menu:e},function(e){var t=$(e.target).siblings();t.removeClass("selected"),t.find("ul").hide(),e.data.viewport.showMenu(e.target)}),this.menuRecurse(i,t[n]))},this.showMenu=function(e){node=$(e),node.addClass("selected"),node.children("ul").show()},this.hideMenu=function(e){void 0===e&&(e=this.menu_node),e.find("ul").hide(),e.find(".selected").removeClass("selected")},this.toggleMenu=function(e){this.hideMenu(),this.showMenu(e)}}HeaderViewport.prototype=new AbstractViewport;
